...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tubes/image/Group 2.png"))); // NOI18N
        jPanel1.add(jLabel3);
        jLabel3.setBounds(0, -270, 380, 780);
    ...
    private void kButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kButton1MouseClicked
        ...
        if(id.substring(0, 2).equals("KA") || id.substring(0, 2).equals("AD")){
            ...
            com = "SELECT * FROM mahasiswa WHERE nim='" + id + "'";
...
//       File as = new File(filePath);
//        if(as.delete()){
//        System.out.println("File "+as.getName() + " berhasil di hapus");
//        }else{
...
//         }
        ...
        BigDecimal balance=null;
            ...
            Statement stat;
            String query = "SELECT * FROM mahasiswa where nim = '"+id+"'";
        try {
