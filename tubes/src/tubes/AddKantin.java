...
public class AddKantin extends javax.swing.JFrame {
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        try {
            connect koneks = new connect();
            Connection koneksi = koneks.getConnection();
            String id = uName1.getText();
            String nama = uName.getText();
            String query = "insert into kantin values ('"+id+"','"+nama+"',0)";
            PreparedStatement statS = (PreparedStatement) koneksi.prepareStatement(query);
            statS.executeUpdate();
            JOptionPane.showMessageDialog(null, "Kantin Berhasil Ditambahkan", "Berhasil", WIDTH);
            dispose();
        } catch (SQLException ex) {
           JOptionPane.showMessageDialog(null, "Data Tidak Berhasil Ditambahkan", "Gagal", WIDTH);
        }
